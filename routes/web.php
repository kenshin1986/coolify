...
use App\Livewire\Source\Github\Repositories as GitHubRepositories;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/source/github/{github_app_uuid}/repositories', GitHubRepositories::class)->name('source.github.repositories');
});
